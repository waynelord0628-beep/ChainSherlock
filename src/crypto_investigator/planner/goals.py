...
class GoalType(StrEnum):
    ...
    ADDRESS_POISONING_ANALYSIS = "address_poisoning_analysis"
    DUST_SPAM_INVESTIGATION = "dust_spam_investigation"
    SIMILAR_ADDRESS_DETECTION = "similar_address_detection"
